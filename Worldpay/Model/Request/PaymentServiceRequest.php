...
{
    /**
     * @var \Zyxware\Worldpay\Model\Request $request
     */
    protected $_request;
    ...
    public function order3DSecure($directOrderParams)
    {
        ...
        $this->xmldirectorder = new \Zyxware\Worldpay\Model\XmlBuilder\DirectOrder($requestConfiguration);
    ...
    public function orderToken($tokenOrderParams)
    {
        ...
        $this->xmltokenorder = new \Zyxware\Worldpay\Model\XmlBuilder\DirectOrder($requestConfiguration);
    ...
    public function redirectOrder($redirectOrderParams)
    {
        ...
        $this->xmlredirectorder = new \Zyxware\Worldpay\Model\XmlBuilder\RedirectOrder($requestConfiguration);
    ...
    public function redirectKlarnaOrder($redirectOrderParams)
    {
        ...
        $this->xmlredirectorder = new \Zyxware\Worldpay\Model\XmlBuilder\RedirectKlarnaOrder();
        $redirectSimpleXml = $this->xmlredirectorder->build(
            $redirectOrderParams['merchantCode'],
            $redirectOrderParams['orderCode'],
            $redirectOrderParams['orderDescription'],
    ...
    public function DirectIdealOrder($redirectOrderParams)
    {
        ...
        $this->xmldirectidealorder = new \Zyxware\Worldpay\Model\XmlBuilder\DirectIdealOrder($requestConfiguration);
    ...
    public function capture(\Magento\Sales\Model\Order $order, $wp, $paymentMethodCode)
    {
        ...
        $this->xmlcapture = new \Zyxware\Worldpay\Model\XmlBuilder\Capture();
    ...
    public function refund(
        ...
        $this->xmlrefund = new \Zyxware\Worldpay\Model\XmlBuilder\Refund();
    ...
    public function inquiry($merchantCode, $orderCode, $storeId, $paymentMethodCode, $paymenttype)
    {
        ...
        $this->xmlinquiry = new \Zyxware\Worldpay\Model\XmlBuilder\Inquiry();
    ...
    public function tokenUpdate(
        ...
        $this->tokenUpdateXml = new \Zyxware\Worldpay\Model\XmlBuilder\TokenUpdate($requestParameters);
    ...
    public function tokenDelete(
        ...
        /** @var SimpleXMLElement $simpleXml */
        $this->tokenDeleteXml = new \Zyxware\Worldpay\Model\XmlBuilder\TokenDelete($requestParameters);
    ...
    public function paymentOptionsByCountry($paymentOptionsParams)
    {
         ...
         $this->xmlpaymentoptions = new \Zyxware\Worldpay\Model\XmlBuilder\PaymentOptions();
