...
abstract class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    protected $_wplogger;
    /**
     * @var \Zyxware\Worldpay\Model\Authorisation\DirectService
     */
    ...
    /**
     * @var \Zyxware\Worldpay\Model\WorldpaymentFactory
     */
     ...
     * @param \Zyxware\Worldpay\Model\Authorisation\DirectService $directservice
     * @param \Zyxware\Worldpay\Model\Authorisation\RedirectService $redirectservice
     * @param \Zyxware\Worldpay\Model\Authorisation\TokenService $tokenservice
     * @param \Zyxware\Worldpay\Model\Authorisation\MotoRedirectService $motoredirectservice
     * @param \Zyxware\Worldpay\Model\Authorisation\HostedPaymentPageService $hostedpaymentpageservice
     * @param \Zyxware\Worldpay\Helper\Registry $registryhelper
     * @param \Magento\Framework\UrlInterface $urlBuilder
     * @param \Zyxware\Worldpay\Helper\Data $worldpayhelper
     * @param \Zyxware\Worldpay\Model\WorldpaymentFactory $worldpaypayment
     ...
     * @param \Zyxware\Worldpay\Model\Response\AdminhtmlResponse $adminhtmlresponse
    ...
    public function __construct(
        ...
        \Zyxware\Worldpay\Model\Authorisation\DirectService $directservice,
        \Zyxware\Worldpay\Model\Authorisation\RedirectService $redirectservice,
        \Zyxware\Worldpay\Model\Authorisation\TokenService $tokenservice,
        \Zyxware\Worldpay\Model\Authorisation\MotoRedirectService $motoredirectservice,
        \Zyxware\Worldpay\Model\Authorisation\HostedPaymentPageService $hostedpaymentpageservice,
        ...
        \Zyxware\Worldpay\Model\Response\AdminhtmlResponse $adminhtmlresponse,
        ...
        \Zyxware\Worldpay\Model\Payment\PaymentTypes $paymenttypes,
    ...
    private function _createWorldPayPayment(\Magento\Payment\Model\InfoInterface $payment, $orderCode, $storeId,$orderId,$interactionType='ECOM')
    {
        ...
        $wpp->setData('payment_status',\Zyxware\Worldpay\Model\Payment\State::STATUS_SENT_FOR_AUTHORISATION);
    ...
    private function _isRefundAllowed($state)
    {
        $allowed = in_array(
            $state,
            array(
                \Zyxware\Worldpay\Model\Payment\State::STATUS_CAPTURED,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_SETTLED,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_SETTLED_BY_MERCHANT,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_SENT_FOR_REFUND,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_REFUNDED,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_REFUNDED_BY_MERCHANT,
                \Zyxware\Worldpay\Model\Payment\State::STATUS_REFUND_FAILED
            )
        );
        return $allowed;
    }
