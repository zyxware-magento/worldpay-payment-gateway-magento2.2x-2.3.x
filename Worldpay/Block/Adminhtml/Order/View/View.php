 ...
 */
namespace Zyxware\Worldpay\Block\Adminhtml\Order\View;
...
class View extends \Magento\Backend\Block\Template
{
     ...
     * @param \Zyxware\Worldpay\Model\WorldpaymentFactory $worldpaymentFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Framework\Registry $registry,
        \Zyxware\Worldpay\Model\WorldpaymentFactory $worldpaymentFactory,
        array $data = []
    ) {
