...
{
    /**
     * @var \Zyxware\Worldpay\Block\Adminhtml\Form\Field\Paymentmethod
     */
     ...
     *
     * @return \Zyxware\Worldpay\Block\Adminhtml\Form\Field\Activation
     */
    protected function _getpaymentMethodRenderer()
    {
        if (!$this->_paymentMethod) {
            $this->_paymentMethod = $this->getLayout()->createBlock(
                '\Zyxware\Worldpay\Block\Adminhtml\Form\Field\Paymentmethod',
                '',
    ...
    {   
        ...
        $this->addColumn('merchant_password', ['label' => __('Merchant Password'), 
            'renderer' => $this->getLayout()->createBlock(
                '\Zyxware\Worldpay\Block\Adminhtml\Form\Field\Password'
            )
            ]); 
